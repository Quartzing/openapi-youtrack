...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/admin/databaseBackup/backups/{id}".format(
            id=id,
        ),
        "params": params,
    }
...
def _parse_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Optional[BackupFile]:
...
def _build_response(*, client: Union[AuthenticatedClient, Client], response: httpx.Response) -> Response[BackupFile]:
    return Response(
