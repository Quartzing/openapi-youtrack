...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/admin/customFieldSettings/bundles/user/{id}/groups".format(
            id=id,
        ),
        "params": params,
    }
...
def sync_detailed(
    ...
    *,
    ...
    Args:
        id (str):
        fields (Union[Unset, None, str]):  Default: '$type,allUsersGroup,id,name,ringId'. Example:
            $type,allUsersGroup,id,name,ringId.
