...
def _get_kwargs(
    ...
    *,
    ...
    return {
        "method": "get",
        "url": "/admin/customFieldSettings/bundles/enum/{id}/values".format(
            id=id,
        ),
        "params": params,
    }
...
) -> Optional[List["EnumBundleElement"]]:
    if response.status_code == HTTPStatus.OK:
        response_200 = []
        _response_200 = response.json()
        for response_200_item_data in _response_200:
            response_200_item = EnumBundleElement.from_dict(response_200_item_data)
...
def _build_response(
    *, client: Union[AuthenticatedClient, Client], response: httpx.Response
) -> Response[List["EnumBundleElement"]]:
    return Response(
